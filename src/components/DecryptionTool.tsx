...
export const DecryptionTool = ({ initialCiphertext }: DecryptionToolProps = {}) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 w-full overflow-hidden">
      {/* Scanner Overlay */}
      {showScanner && (
      ...
      <div className="bg-surface p-6 rounded-xl border border-slate-800 space-y-6">
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full h-32 bg-slate-900/50 border border-slate-700 rounded-lg p-3 text-base md:text-sm font-mono focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all resize-y"
        ...
        <Button
          ...
          className="w-full h-auto min-h-[3rem] py-3 text-base sm:text-lg font-bold bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-600/90 shadow-lg shadow-primary/20 whitespace-normal break-words"
        >
          <Unlock size={20} className="mr-2 shrink-0" />
          <span>{t('decryption.button.decrypt')}</span>
        </Button>
      ...
      {rows && (
        <div className="space-y-6 border-t border-slate-800 pt-8 animate-in slide-in-from-bottom-4 w-full overflow-hidden">
          ...
          <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800 space-y-4 w-full overflow-hidden">
             <div className="flex items-center justify-between flex-wrap gap-4">
                <h3 className="font-semibold text-slate-300 flex items-center gap-2">
                    ...
                    <div className="relative group/tooltip">
                        ...
                        <div className="hidden md:group-hover/tooltip:block absolute bottom-full left-0 mb-2 px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg shadow-xl text-xs text-slate-300 w-64 z-50">
                ...
                <div className="grid grid-cols-5 bg-slate-950 p-1 rounded-lg border border-slate-800 gap-1 overflow-hidden w-full max-w-full">
                    {[
                        ...
                        <button
                            ...
                            className={`px-1 py-1.5 rounded-md text-xs font-medium transition-all flex items-center justify-center gap-1.5 w-full min-w-0 ${
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full overflow-hidden">
              {/* Row Selector */}
              <div className="md:w-1/3 space-y-4 min-w-0">
              ...
              <div className="md:w-2/3 space-y-4 min-w-0">
                  {recoveredMnemonic !== null ? (
                      <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-5 space-y-3 animate-in zoom-in-95">
                          ...
                          <div className="bg-slate-950 p-4 rounded-lg font-mono text-green-400 break-words leading-relaxed border border-green-500/20 shadow-inner whitespace-pre-wrap [overflow-wrap:anywhere] max-w-full overflow-x-auto">
                  ...
                  <div className="space-y-2 w-full overflow-hidden">
                      ...
                      <div className="h-64 overflow-y-auto overflow-x-auto custom-scrollbar bg-slate-950 rounded-xl border border-slate-800">
                          {rows.map((row, idx) => (
                              <div
                                key={idx}
                              ...
                              >
                                  ...
                                  <div className="p-2 font-mono text-xs flex-1 opacity-70 overflow-x-auto whitespace-nowrap">
                                      {row.join('  ')}
                                  </div>
                              </div>
                          ))}
