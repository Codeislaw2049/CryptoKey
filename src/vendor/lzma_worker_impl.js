...
var LZMA = (function () {
    ...
    var /** cs */
        ...
        /** de */
        action_progress   = 3,
        wait = function(cb, t) { setTimeout(cb, t || 0); },
    ...
    function $init(this$static, input, output, length_0, mode) {
        ...
        encoder._writeEndMark = typeof LZMA == "undefined" || typeof LZMA.disableEndMark == "undefined";
    ...
    function compress(str, mode, on_finish, on_progress) {
        ...
        try {
            ...
            console.error("LZMA compress error (init):", err);
        ...
        function do_action() {
            try {
                ...
                console.error("LZMA compress error (async):", err);
                on_finish(null, err);
            }
        }
